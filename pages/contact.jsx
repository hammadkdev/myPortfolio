        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Pixako Technologies</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Email:</span>
                                <span className='text-LightGray text-sm'>hammadk.dev@gmail.com</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Linkedin:</span>
                                <span className='text-LightGray text-sm'>hammadkdev</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Phone:</span>
                                <span className='text-LightGray text-sm'>+92 (318) 9668328</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/hammadkdev" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.linkedin.com/in/hammadkdev/" target='_blank' rel="noreferrer"><FaLinkedin /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href='https://github.com/hammadkdev/myPortfolio'>Working on this Feature!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
